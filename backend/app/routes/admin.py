...
def assign_volunteer():
    ...
    admin_id = get_jwt_identity()
    log_action(admin_id, "VOLUNTEER_ASSIGNED", "Assignment", assignment.id, f"Assigned volunteer '{volunteer.full_name}' to request ID {request_id}")
    ...
    return jsonify({'success': True, 'message': 'Volunteer assigned successfully', 'assignment': assignment.to_dict()})
